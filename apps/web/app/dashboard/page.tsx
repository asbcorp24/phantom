export default function Dashboard(){
 return <main className="dashboard"><aside><div className="brand">PHANTOM</div><nav><a href="/dashboard">Главная</a><a href="/my-courses">Мои программы</a><a href="/certificates">Сертификаты</a><a href="/requests">Обращения</a><a href="/assistant">ИИ-помощник</a></nav></aside>
